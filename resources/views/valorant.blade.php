@extends('layouts.default')
    ...
    <div class="">
        ...
        <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pendaftaran Lomba Valorant</h4>
                  <p class="card-description">
                    Lengkapi Semua Kolom Ya
                  </p>
                  <form class="forms-sample" action="/daftar/valorant/submit" method="post" enctype="multipart/form-data">
                    @csrf
                    <div x-data="app()" x-cloak>
                      <div class="form-section" x-show.transition.in="step === 1">
                      ...
                      <div class="form-section  mt-5 pt-5" x-show.transition.in="step === 2">
                        ...
                        <div class="form-group">
                            <label for="namaKetua">Tagline</label>
                            <input type="text" class="form-control" id="idKetua" name="idKetua" placeholder="Tagline" required>
                        </div>
                        <div class="form-group">
                      ...
                      <div class="form-section mt-5 pt-5" x-show.transition.in="step === 3">
                        ...
                        <div class="form-group">
                            <label for="namaKetua">Tagline</label>
                            <input type="text" class="form-control" id="id2" name="id2" placeholder="Tagline" required>
                        </div>
                        <div class="form-group">
                            <label for="namaKetua">Alamat</label>
                      ...
                      <div class="form-section mt-5 pt-5" x-show.transition.in="step === 4">
                        ...
                        <div class="form-group">
                            <label for="namaKetua">Tagline</label>
                            <input type="text" class="form-control" id="id3" name="id3" placeholder="Tagline" required>
                        </div>
                        <div class="form-group">
                            <label for="namaKetua">Alamat</label>
                      ...
                      <div class="form-section mt-5 pt-5" x-show.transition.in="step === 5">
                        ...
                        <div class="form-group">
                            <label for="namaKetua">Tagline</label>
                            <input type="text" class="form-control" id="id4" name="id4" placeholder="Tagline" required>
                        </div>
                        <div class="form-group">
                            <label for="namaKetua">Alamat</label>
                      ...
                      <div class="form-section mt-5 pt-5" x-show.transition.in="step === 6">
                        <div class="form-group">
                            <label for="namaKetua">Nama Member Tim 5</label>
                        ...
                        <div class="form-group">
                            <label for="namaKetua">Tagline</label>
                            <input type="text" class="form-control" id="id5" name="id5" placeholder="Tagline" required>
                        </div>
                        <div class="form-group">
                            <label for="namaKetua">Alamat</label>
                      ...
                      <div class="form-section mt-5 pt-5" x-show.transition.in="step === 7">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama6" name="nama6" placeholder="Nama Member Tim Cadangan" required>
                        </div>
                        <div class="form-group">
                            <label for="namaKetua">Nick</label>
                            <input type="text" class="form-control" id="nick6" name="nick6" placeholder="Nick" required>
                        </div>
                        <div class="form-group">
                            <label for="namaKetua">Tagline</label>
                            <input type="text" class="form-control" id="id6" name="id6" placeholder="Tagline" required>
                        </div>
                        <div class="form-group">
                            <label for="namaKetua">Alamat</label>
                            <input type="text" class="form-control" id="alamat6" name="alamat6" placeholder="Alamat" required>
                        </div>
                        <div class="form-group">
                            <label for="namaKetua">No HP/Wa</label>
                            <input type="text" class="form-control" id="nohp6" name="nohp6" placeholder="No HP/Wa" required>
                        </div>
                      </div>
                      <div class="form-section mt-5 pt-5" x-show.transition.in="step === 8">
                        <div class="form-group">
                      ...
                      <div class="form-navigation">
                        <div x-show="step != 'complete'">
                            ...
                            <button x-show="step < 8" type="button" class="next btn btn-info float-right">Next</button>
    ...
    <script>
        function showValidate() {
            document.getElementById("valid").innerHTML = "Kolom belum terisi seluruhnya! Lengkapi kolom dari awal sampai akhir!";
        }
